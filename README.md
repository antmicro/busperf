...
Busperf data viewer can be compiled to WASM. This allows viewing data files generated by busperf in browser.
...
- Generates html with embedded data and viewer app
<!-- name="example-html" -->
```sh
